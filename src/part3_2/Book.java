...
public class Book {
    ...
    public String searchBook() { // 책 제목 조회
        return title;
    }

    public boolean searchBorrowIsAvailable() { // 대여여부 조회
        return isAvailable;
    }

    public void setBorrowIsAvailable(boolean avilable) { // 대여여부 설정
